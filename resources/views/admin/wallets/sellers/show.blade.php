        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Seller Wallet</h4>
                </div>
                <div class="card-body">
                    <x-alerts />
                    <div class="row">
                        ...
                        <div class="col-sm col-md-4">
                            <div class="card border rounded">
                                <div class="card-header">
                                    <div class="card-title">Commission (5%)</div>
                                </div>
                                <div class="card-body">
                                    <h1 class="text-success">
                                        ₹{{ number_format((($wallet->current_earnings*5)/100), 2) }}
                                    </h1>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm col-md-8">
                            <h4>Seller Info:</h4>
                            <p class="mb-0">Name : {{ $wallet->owner->name }}</p>
                            <p class="mb-0">Phone : {{ $wallet->owner->phone }}</p>
                            <p class="mb-0">Email : {{ $wallet->owner->email }}</p>
                        </div>
                        <div class="col-sm col-md-4">
                            <table>
                                <tr>
                                    <td>Current Earning : </td>
                                    <td class="text-success">&nbsp;₹{{ number_format($wallet->current_earnings, 2) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>Commission (5%) : </td>
                                ...
                                <tr class="fw-bold ">
                                    ...
                                    <td class="text-success">
                                        ₹{{number_format(($wallet->current_earnings-($wallet->current_earnings*5)/100),2)}}
                                    </td>
                                </tr>
                            </table>
                            <br>
                            <div>
                                <form action="{{ route('admin.wallets.sellers.payoff', $wallet) }}" method="POST">
                                    @csrf
                                    @method("put")
                        ...
                        <div class="col-12">
                            <small class="my-1">Note : Payoff makes wallet current earning ZERO</small>
                        </div>
                    </div>
                </div>
            </div>
