        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title capitalize">franchise orders</h4>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    <div class="table">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <span class="fw-bold capitalize">{{ $order->franchise->name }}</span>
                                    </td>
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item"
                                                    href="{{ route('admin.franchises_orders.show', $order) }}">
