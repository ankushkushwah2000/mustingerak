  ...
  <div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
      <div class="row breadcrumbs-top">
        <div class="col-12">
          <h2 class="content-header-title float-start mb-0 capitalize">categorys</h2>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">You have total {{ count($categories) }} category</h4>
          ...
          <div class="table">
            <table class="table table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    <img src="{{ imgSrc($category->image) }}" class="me-75" height="20" width="20" alt="image" />
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a onclick="event.preventDefault(); document.getElementById( {{ $category->id}} ).submit();"
