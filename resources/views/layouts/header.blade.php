  ...
  <div class="navbar-container d-flex content">
    <div class="bookmark-wrapper d-flex align-items-center">
      <ul class="nav navbar-nav d-xl-none">
        ...
        <li class="nav-item d-none d-lg-block"><a class="nav-link" href="/app/email" data-bs-toggle="tooltip"
            data-bs-placement="bottom" title="Email"><i class="ficon" data-feather="mail"></i></a></li>
        <li class="nav-item d-none d-lg-block"><a class="nav-link" href="/app/chat" data-bs-toggle="tooltip"
            data-bs-placement="bottom" title="Chat"><i class="ficon" data-feather="message-square"></i></a></li>
        <li class="nav-item d-none d-lg-block"><a class="nav-link" href="/app/calendar" data-bs-toggle="tooltip"
            data-bs-placement="bottom" title="Calendar"><i class="ficon" data-feather="calendar"></i></a></li>
        <li class="nav-item d-none d-lg-block"><a class="nav-link" href="/app/todo" data-bs-toggle="tooltip"
    ...
    <ul class="nav navbar-nav align-items-center ms-auto">
        ...
        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
          ...
          <li class="scrollable-container media-list">
            <div class="list-item align-items-center">
              <img class="d-block rounded me-1" src="/images/pages/eCommerce/1.png" alt="donuts" width="62">
              <div class="list-item-body flex-grow-1">
                <i class="ficon cart-item-remove" data-feather="x"></i>
                <div class="media-heading">
                  <h6 class="cart-item-title"><a class="text-body" href="/app/ecommerce/details">
                      Apple
            ...
            <div class="list-item align-items-center">
              <img class="d-block rounded me-1" src="/images/pages/eCommerce/7.png" alt="donuts" width="62">
              <div class="list-item-body flex-grow-1">
                <i class="ficon cart-item-remove" data-feather="x"></i>
                <div class="media-heading">
                  <h6 class="cart-item-title"><a class="text-body" href="/app/ecommerce/details">
            ...
            <div class="list-item align-items-center">
              <img class="d-block rounded me-1" src="/images/pages/eCommerce/2.png" alt="donuts" width="62">
              <div class="list-item-body flex-grow-1">
                <i class="ficon cart-item-remove" data-feather="x"></i>
                <div class="media-heading">
                  <h6 class="cart-item-title"><a class="text-body" href="/app/ecommerce/details">
            ...
            <div class="list-item align-items-center">
              <img class="d-block rounded me-1" src="/images/pages/eCommerce/3.png" alt="donuts" width="62">
              <div class="list-item-body flex-grow-1">
                <i class="ficon cart-item-remove" data-feather="x"></i>
                <div class="media-heading">
                  <h6 class="cart-item-title"><a class="text-body" href="/app/ecommerce/details">
            ...
            <div class="list-item align-items-center">
              <img class="d-block rounded me-1" src="/images/pages/eCommerce/5.png" alt="donuts" width="62">
              <div class="list-item-body flex-grow-1">
                <i class="ficon cart-item-remove" data-feather="x"></i>
                <div class="media-heading">
                  <h6 class="cart-item-title"><a class="text-body" href="/app/ecommerce/details">
          ...
          <li class="dropdown-menu-footer">
            ...
            <a class="btn btn-primary w-100" href="/app/ecommerce/checkout">Checkout</a>
          </li>
        </ul>
      </li> --}}
          ...
          <li class="scrollable-container media-list">
            <a class="d-flex" href="javascript:void(0)">
              <div class="list-item d-flex align-items-start">
                <div class="me-1">
                  <div class="avatar">
                    <img src="/images/portrait/small/avatar-s-15.jpg" alt="avatar" width="32" height="32">
                  </div>
                </div>
                <div class="list-item-body flex-grow-1">
            ...
            <a class="d-flex" href="javascript:void(0)">
              <div class="list-item d-flex align-items-start">
                <div class="me-1">
                  <div class="avatar">
                    <img src="/images/portrait/small/avatar-s-3.jpg" alt="avatar" width="32" height="32">
                  </div>
                </div>
                <div class="list-item-body flex-grow-1">
      ...
      <li class="nav-item dropdown dropdown-user">
        ...
        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
          ...
          <a class="dropdown-item" href="{{ route('hub_manager.profile.index') }}">
            <i class="me-50" data-feather="user"></i> Profile
          </a>
          @break
          @case(\App\Models\Role::IS_DELIVERY_AGENT)
          <a class="dropdown-item" href="{{ route('delivery_agent.profile.index') }}">
            <i class="me-50" data-feather="user"></i> Profile
          </a>
          @break
          @case(\App\Models\Role::IS_FRANCHISE_MANAGER)
          <a class="dropdown-item" href="{{ route('franchise_manager.profile.index') }}">
            <i class="me-50" data-feather="user"></i> Profile
          </a>
          @break
          @case(\App\Models\Role::IS_FRANCHISE_STAFF)
          <a class="dropdown-item" href="{{ route('franchise_staff.profile.index') }}">
            <i class="me-50" data-feather="user"></i> Profile
          </a>
          @break
          @default
...
<ul class="main-search-list-defaultlist d-none">
  ...
  <li class="auto-suggestion">
    <a class="d-flex align-items-center justify-content-between w-100" href="/app/file-manager">
      <div class="d-flex">
        <div class="me-75">
  ...
  <li class="auto-suggestion">
    <a class="d-flex align-items-center justify-content-between py-50 w-100" href="/app/user/view">
