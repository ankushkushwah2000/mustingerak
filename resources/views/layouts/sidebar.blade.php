    ...
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      <li class="nav-item  ">
        ...
        <ul class="menu-content">
          ...
          <li>
            <a href="#" class="d-flex align-items-center" target="_self">
              <i data-feather="circle"></i>
              <span class="menu-item text-truncate">Sellers</span>
            </a>
          </li>
          <li>
            <a href="#" class="d-flex align-items-center" target="_self">
              <i data-feather="circle"></i>
              <span class="menu-item text-truncate">Agents</span>
            </a>
          </li>
        </ul>
      </li>
      <li class="nav-item  ">
        ...
        <ul class="menu-content">
          <li>
            <a href="#" class="d-flex align-items-center" target="_self">
              <i data-feather="circle"></i>
              <span class="menu-item text-truncate">About Us</span>
            </a>
          </li>
          <li>
            <a href="#" class="d-flex align-items-center" target="_self">
              <i data-feather="circle"></i>
              <span class="menu-item text-truncate">Privacy Policy</span>
            </a>
          </li>
          <li>
            <a href="#" class="d-flex align-items-center" target="_self">
              <i data-feather="circle"></i>
              <span class="menu-item text-truncate">TOS</span>
            </a>
          </li>
        </ul>
      </li>
      <li class="nav-item  ">
        <a href="#" class="d-flex align-items-center" target="_self">
          ...
          <span class="menu-title text-truncate">Blank</span>
        </a>
      </li>
    </ul>
