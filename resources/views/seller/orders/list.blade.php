        ...
        <div class="card">
          <div class="card-header">
            ...
            <h4 class="card-title">You have total {{ $count }} {{ \Str::plural('order',
              $count) }}</h4>
            {{-- <a href="{{ route('seller.orders.create') }}" class="btn btn-primary">Create</a> --}}
          </div>
          <div class="table">
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-end">
                        <a class="dropdown-item" href="{{ route('seller.orders.show', $order) }}">
                          <i data-feather="eye" class="me-50"></i>
                          <span>Show</span>
                        </a>
                        {{-- <a class="dropdown-item" href="{{ route('seller.orders.edit', $order) }}">
                          <i data-feather="edit-2" class="me-50"></i>
                          <span>Edit</span>
                        </a> --}}
                        <form action="{{ route('seller.orders.destroy', $order) }}" method="POST" id="{{ $order->id }}">
                          @csrf
                          @method("delete")
                        </form>
