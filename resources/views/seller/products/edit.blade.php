    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <x-alerts />
                    <form class="form" action="{{ route('seller.products.update', $product) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        @endif
                                        >
                                        <label class="form-check-label" for="is_gift_wrap_available">cod_enable</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                            ...
                            <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    ...
                                    <select name="category_id" id="" class="form-control">
                                        ...
                                        <option value="{{ $category->id }}" @if ($product->category_id ===
                                            $category->id)
                                            selected
                                            @endif
                            ...
                            <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    ...
                                    <select name="sub_category_id" id="" class="form-control">
                                        ...
                                        <option value="{{ $category->id }}" @if ($product->sub_category_id ===
                                            $category->id)
                                            selected
                                            @endif
                                            >{{ $category->title }}</option>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="title">select sub sub category</label>
                                    <select name="sub_sub_category_id" id="" class="form-control">
                                        @foreach ($subsubcategories as $category)
                                        <option value="{{ $category->id }}" @if ($product->sub_sub_category_id ===
                                            $category->id)
                                            selected
                                            @endif
                                            >{{ $category->title }}</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-12">
                            <div class="mb-1">
                                <label class="form-label" for="title">Thumbnail video preview</label>
                                <br>
                                @foreach ($product->video as $videos )
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm col-md-2">
                                    <img src="{{ $image->path }}" class="border border-primary rounded" height="120"
                                        alt="image" />
                                    <form action="{{ route('seller.product.images.delete', $image) }}" method="POST"
